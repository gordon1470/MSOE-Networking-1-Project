...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0"
`include "D:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "D:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0"
`include "D:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_Timer_v2_70"
`include "D:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_Timer_v2_70\B_Timer_v2_70.v"
`else
`define CY_BLK_DIR "D:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_Timer_v2_70"
`include "D:\Program Files\Cypress\PSoC Creator\3.3\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\B_Timer_v2_70\B_Timer_v2_70.v"
`endif
...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=true, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=1, NumberOfCaptures=1, param45=1, Period=23743, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=1, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=Timer_v2_70, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Receive_Timer, CY_INSTANCE_SHORT_NAME=Receive_Timer, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=Receive_Timer, )
...
module top ;
    ...
    Timer_v2_70_3 Idle_Collision_Timer (
        .reset(Net_201),
        .interrupt(Net_143),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_100),
        .clock(Net_149));
    defparam Idle_Collision_Timer.CaptureCount = 2;
    defparam Idle_Collision_Timer.CaptureCounterEnabled = 0;
    defparam Idle_Collision_Timer.DeviceFamily = "PSoC5";
    defparam Idle_Collision_Timer.InterruptOnCapture = 0;
    defparam Idle_Collision_Timer.InterruptOnTC = 0;
    defparam Idle_Collision_Timer.Resolution = 16;
    defparam Idle_Collision_Timer.SiliconRevision = "0";
	...
	cy_clock_v1_0
		#(.id("64c7cf30-2649-4ab3-9df3-86e881d58fda"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("815e00fc-0a02-4cff-8345-08b406e37b94"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b4788912-8a9e-4528-a35c-732b9753d064"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8f5d22fb-ab85-43ee-9bb8-c8a599ce1de4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Timer_v2_70_4 Receive_Timer (
        ...
        .tc(Net_209),
        .clock(Net_204));
    defparam Receive_Timer.CaptureCount = 2;
    defparam Receive_Timer.CaptureCounterEnabled = 0;
    defparam Receive_Timer.DeviceFamily = "PSoC5";
    defparam Receive_Timer.InterruptOnCapture = 0;
    defparam Receive_Timer.InterruptOnTC = 1;
    defparam Receive_Timer.Resolution = 16;
    defparam Receive_Timer.SiliconRevision = "0";


	cy_clock_v1_0
		#(.id("e4891eb2-ed4f-4e0f-9774-1500336a1209"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3d4513d2-c07c-4be9-90c1-f2520e04b203"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
