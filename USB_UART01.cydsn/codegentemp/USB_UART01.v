...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8fa3d722-0cb5-408c-87dc-accc4d28d5b8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LED4_1_net;
	wire [0:0] tmpFB_0__LED4_1_net;
	wire [0:0] tmpIO_0__LED4_1_net;
	wire [0:0] tmpINTERRUPT_0__LED4_1_net;
	electrical [0:0] tmpSIOVREF__LED4_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("815e00fc-0a02-4cff-8345-08b406e37b94"),
		  ...
		  .input_buffer_sel(2'b00))
		LED4_1
		 (.oe(tmpOE__LED4_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED4_1_net[0:0]}),
		  .io({tmpIO_0__LED4_1_net[0:0]}),
		  .siovref(tmpSIOVREF__LED4_1_net),
		  .interrupt({tmpINTERRUPT_0__LED4_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED4_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
